              ...
              <div className="moveLink absolute text-black flex top-0 bg-[#D3FD50]">
                <div className="moveX flex items-center">
                  ...
                  <img
                    ...
                    src="https://www.railway-technology.com/wp-content/uploads/sites/13/2020/06/Image-1-Chenab-Bridge.jpg"
                    alt=""
                  />
                  <h2 className="whitespace-nowrap font-[font2] lg:text-[8vw] text-5xl  text-center lg:leading-[0.8] lg:pt-10 pt-4 uppercase">
                    Amazing India
                  ...
                  <img
                    className="lg:h-36 h-14 rounded-full shrink-0 lg:w-96 w-32 object-cover"
                    src="https://lh6.googleusercontent.com/proxy/VslUqyT-peddWFTLk7SqyR_kJC3towRCWde1P1-XHvt4e4ZaNEVb5pH3j2XDiTWtRDOryDvEzg"
                    alt=""
                  />
                </div>
                <div className="moveX flex items-center">
                  ...
                  <img
                    className="lg:h-36 h-14 rounded-full shrink-0 lg:w-96 w-32 object-cover"
                    src="https://i.cdn.newsbytesapp.com/images/l64920250611112612.jpeg"
                    alt=""
                  />
                  <h2 className="whitespace-nowrap font-[font2] lg:text-[8vw] text-5xl  text-center lg:leading-[0.8] lg:pt-10 pt-4 uppercase">
                    Amazing India
                  ...
                  <img
                    className="lg:h-36 h-14 rounded-full shrink-0 lg:w-96 w-32 object-cover"
                    src="https://www.alightindia.com/cdn/uploads/postimages/ORIGINAL/Chandrayaan%203--94b160.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div className="link origin-top relative border-t-1 border-white">
              ...
              <div className="moveLink absolute text-black flex top-0 bg-[#D3FD50]">
                <div className="moveX flex items-center">
                  ...
                  <img
                    className="lg:h-36 h-14 rounded-full shrink-0 lg:w-96 w-32 object-cover"
                    src="https://miro.medium.com/1*nouIPjeyS-HVsQ6U18zMXQ.jpeg"
                    alt=""
                  />
                  <h2 className="whitespace-nowrap font-[font2] lg:text-[8vw] text-5xl  text-center lg:leading-[0.8] lg:pt-10 pt-4 uppercase">
                    Amazing India
                  ...
                  <img
                    className="lg:h-36 h-14 rounded-full shrink-0 lg:w-96 w-32 object-cover"
                    src="https://i.pinimg.com/originals/36/c8/21/36c82157786a6d305152a9b8ea24a85b.jpg"
                    alt=""
                  />
                </div>
                <div className="moveX flex items-center">
