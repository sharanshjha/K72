...
import { NavbarColorContext, NavbarContext } from '../../context/contexts'

/**
 * Navbar - top navigation bar that opens the full-screen nav on click.
 * Uses context to toggle the overlay and to pick the logo color based on route.
 */
const Navbar = () => {
